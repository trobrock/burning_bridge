...
(function() {
  var Campfire, Client, Command, Rooms, Server, User, campfire, campfire_subdomain, campfire_token, carrier, configuration, fs, handler, net, s, server;
  ...
  s = net.createServer(handler).listen(6666, function() {
