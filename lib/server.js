...
(function() {
  ...
  Server = (function() {
    ...
    Server.prototype.message = function(client, msg) {
    ...
    carrier.carry(socket, function(line) {
      ...
      switch (command.command) {
        ...
        case "USER":
          ...
          return server.message(client, "376 " + (current_user.nick()) + " :End of /MOTD command.");
        case "PING":
        ...
        case "LIST":
          ...
          return server.message(client, "323 " + (current_user.nick()) + " :End of /LIST");
        case "JOIN":
