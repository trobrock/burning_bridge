...
(function() {
  ...
  User = (function() {
    ...
    User.prototype.mask = function() {
      return "" + (this.nick()) + "!" + this.username + "@" + this.campfire.api_host;
    };

    User.prototype.speak_in_room = function(channel, message) {
      return this.find_room(channel, (function(_this) {
    ...
    User.prototype.find_room = function(channel, callback) {
      return this.campfire.presence((function(_this) {
        return function(err, rooms) {
    ...
    User.prototype._fetch = function() {
      return this._fetchFunction()((function(_this) {
